...
class RAPTOR:
    """
    Adds RAPTOR-inspired section- and document-level summary chunks.
    ...
    def _process_document(self, doc_id: str, chunks: list[Document]) -> list[Document]:
        """Create hierarchical summary chunks for one document."""
        # Representative meta (title, source, language, timestamps)
        rep_meta = chunks[0].meta
        leaf_block_size = int(rep_meta.get("__block_size") or 1)
            ...
            section_doc = Document(
                ...
                meta    = {
                    **_base_meta(rep_meta),
                    ...
                    "section_title": section_title,
                        "chunk_type":    "hier_summary_section",
